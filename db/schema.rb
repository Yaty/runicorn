...
ActiveRecord::Schema.define(version: 1) do
  ...
  create_table "fights", force: :cascade do |t|
    t.string "name"
    t.integer "firstUnicorn_id"
    t.integer "secondUnicorn_id"
    t.index ["firstUnicorn_id"], name: "index_fights_on_firstUnicorn_id"
    t.index ["secondUnicorn_id"], name: "index_fights_on_secondUnicorn_id"
  end
